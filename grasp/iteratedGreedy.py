...
def grasp_iterated_greedy_algorithm(sudoku, k, D, max_iterations, I):
    ...
    while best_violations > 0 and iterations < max_iterations:
        ...
        new_sudoku, new_violations = semi_greedy_algorithm(sudoku, k)
        new_sudoku, new_violations = iterated_greedy_algorithm(new_sudoku,k,D,(max_iterations * I/100), positions_editable)
